...
void dfs_explore(GraphForTask2 *graph, int u, int *order, bool *visited, int *n_visited);
...
// order[i] == k means that vertex k was visited ith in the order, while
// visited[i] == true means that node i has been visited
void bfs_explore(GraphForTask2 *graph, int u, int *order, bool *visited, int *n_visited);
...
// order[i] == k means that vertex k was visited ith in the order, while
// visited[i] == true means that node i has been visited
void bfs_explore(GraphForTask2 *graph, int start, int *order, bool *visited, int *n_visited) {
  ListForTask2 *queue = new_list();
